...
fallocate -l $(($(df -h | grep "/home/jeongho/mnt" | awk '{print $2}' | sed 's/G//g')/3))G /home/jeongho/mnt/fill/fillme.buf 2>/dev/null
fallocate -l $(($(df -h | grep "/home/jeongho/mnt" | awk '{print $2}' | sed 's/G//g')/3))G /home/jeongho/mnt/fill/fillme.warm 2>/dev/null
fallocate -l $(($(df -h | grep "/home/jeongho/mnt" | awk '{print $2}' | sed 's/G//g')/3))G /home/jeongho/mnt/fill/fillme.sst 2>/dev/null
...
echo "punch hole"
./punch /home/jeongho/mnt/fill/fillme.buf $1
./punch /home/jeongho/mnt/fill/fillme.warm $1
./punch /home/jeongho/mnt/fill/fillme.sst $1
}
